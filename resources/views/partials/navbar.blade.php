<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a href="/home" class="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Vers Bloom</span>
  </a>
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <ul class="inline-flex justify-between">
          <li>
              <a href="">
                  <svg class="w-6 h-6 text-gray-800 dark:text-white hover:text-[#94B49F] mr-4 ml-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg " fill="none" viewBox="0 0 20 20">
            ...
            <li>
              <a href="/login">
                  <svg  class="w-6 h-6 text-gray-800 dark:text-white hover:text-[#94B49F] mr-4 ml-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 18">
            ...
            <li>
              <a href="">
                  <svg href="" class="w-6 h-6 text-gray-800 dark:text-white hover:text-[#94B49F] mr-4 ml-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
