  ...
  <form class="space-y-6" action="/login" method="post">
    @csrf
      ...
      <a href="{{ route('google.login') }}">
        <button type="button" class="w-56 text-black ml-12 bg-[#94B49F] hover:opacity-95 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-base rounded-lg px-5 py-2.5 text-center">
