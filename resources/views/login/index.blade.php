...
<div class="w-full -mt-12 max-w-sm ml-5 p-4 bg-[#F8F3E7] border border-gray-200 rounded-lg shadow lg:ml-36 md:ml-10 ">
  ...
  <form class="space-y-6" action="/login" method="post">
    @csrf
      <p class="text-4xl font-medium text-gray-900 text-center">Sign in</p>
      <div>
      ...
      <button type="submit" class="w-56 text-black  ml-14 bg-[#94B49F] hover:opacity-95 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-base rounded-lg px-5 py-2.5 text-center">Sign In</button>
      <p class="text-center mr-9 font-semibold">OR</p>
      <a href="{{ route('google.login') }}">
        <button type="button" class="w-56 mt-4 text-black ml-14 border text-base border-black hover:bg-white focus:ring-4 focus:outline-none 
