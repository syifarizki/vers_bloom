  ...
  <form class="space-y-6" action="/login" method="post">
    @csrf
      ...
      <button type="submit" class="w-56 text-black  ml-12 bg-[#94B49F] hover:opacity-95 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-base rounded-lg px-5 py-2.5 text-center">Sign In</button>
        ...
        focus:ring-blue-300 font-medium rounded-lg  px-5 py-2.5 text-center me-2 mb-2  "><svg class="w-6 h-6 inline-flex text-gray-800 dark:text-white pr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 19">
