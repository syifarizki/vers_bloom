...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg p-5 sm:ml-64 px-8 pt-5 -mt-5  ">
  ...
  {{-- pdf --}}
  <a href="{{ route('PdfReportingCategory') }}" target="_blank"   class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300
...
<div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
      <a href="{{ route('category.sort', ['sort_by' => 'asc']) }}" class="block px-4 py-2 hover:bg-gray-100">A to Z</a>
      <li>
          <a href="{{ route('category.sort', ['sort_by' => 'desc']) }}" class="block px-4 py-2 hover:bg-gray-100">Z to A</a>
      </li>
      <li>
          <a href="{{ route('category.sort', ['sort_by' => 'latest']) }}" class="block px-4 py-2 hover:bg-gray-100">Latest Category</a>
      </li>
      </ul>
</div>
    </div> 
